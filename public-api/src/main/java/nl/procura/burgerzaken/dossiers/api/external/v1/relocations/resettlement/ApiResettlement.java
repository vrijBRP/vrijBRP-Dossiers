...
package nl.procura.burgerzaken.dossiers.api.external.v1.relocations.resettlement;
...
import nl.procura.burgerzaken.dossiers.api.external.v1.relocations.base.ApiMunicipalAddress;
...
public class ApiResettlement {

  @Schema(required = true)
  private ApiDossier dossier;

  @Schema(required = true)
  private ApiPerson declarant;
  ...
  @Schema(required = true)
  private ApiCountry previousCountry;

  @Schema(required = true)
  private List<ApiResettlementPerson> relocators;
}
