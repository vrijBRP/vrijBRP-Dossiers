...
package nl.procura.burgerzaken.dossiers.api.external.v1.dossier.search;
...
public class ApiSearchRequest {
  ...
  private ApiDateTimePeriod entryDateTimePeriod;

  private ApiDatePeriod startDatePeriod;
