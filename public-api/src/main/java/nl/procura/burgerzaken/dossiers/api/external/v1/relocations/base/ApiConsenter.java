...
public class ApiConsenter extends ApiPerson {

  @Override
  public Person toPerson() {
    Person person = super.toPerson();
    person.addRole(PersonRole.CONSENTER);
    return person;
  }

  public static ApiConsenter of(Person person) {
    if (!person.containsRole(PersonRole.CONSENTER)) {
