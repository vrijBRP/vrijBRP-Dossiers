...
public class Acknowledgement {
  ...
  private final BirthAcknowledgementType type;
  private final Person                   mother;
  private final Person                   acknowledger;
  private final NameSelection            nameSelection;

  public Optional<Person> acknowledger() {
    return Optional.ofNullable(acknowledger);
  }
}
