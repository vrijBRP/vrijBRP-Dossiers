...
public interface ConsentRelocationService<T extends ConsentRelocation> extends RelocationService<T> {

  void addConsent(String dossierId, Person consenter, String consentType);
}
