...
import nl.procura.gba.web.rest.v2.model.zaken.verhuizing.GbaRestBinnenverhuizing;
...
@Component
public class GbaRestIntraMunicipalRelocationConverter implements GbaConverter<IntraMunicipalRelocation> {

  @Override
  public DossierType dossierType() {
    return INTRA_MUNICIPAL_RELOCATION;
  }

  @Override
  public GbaRestZaakType zaakType() {
    return BINNENVERHUIZING;
  }

  @Override
  public IntraMunicipalRelocation toDomainModel(GbaRestZaak zaak) {
    Dossier dossier = toDossier(zaak);
    IntraMunicipalRelocation relocation = new IntraMunicipalRelocation(dossier);
  ...
  public static GbaRestZaak toGbaRestZaak(IntraMunicipalRelocation relocation) {
    ...
    zaak.setAlgemeen(toGbaRestZaakAlgemeen(dossier, BINNENVERHUIZING));
