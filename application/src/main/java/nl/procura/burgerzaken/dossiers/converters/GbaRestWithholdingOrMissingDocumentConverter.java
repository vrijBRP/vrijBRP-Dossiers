...
@Component
public class GbaRestWithholdingOrMissingDocumentConverter implements GbaConverter<WithholdingOrMissingDocument> {

  @Override
  public DossierType dossierType() {
    return DossierType.WITHHOLDING_MISSING_DOCUMENT;
  }

  @Override
  public GbaRestZaakType zaakType() {
    return INHOUD_VERMIS;
  }

  @Override
  public WithholdingOrMissingDocument toDomainModel(GbaRestZaak zaak) {
    Dossier dossier = toDossier(zaak);
    return new WithholdingOrMissingDocument(dossier);
  }
  ...
  public static GbaRestZaak toGbaRestZaak(Extract extract) {
    ...
    zaak.setAlgemeen(toGbaRestZaakAlgemeen(dossier, INHOUD_VERMIS));
    return zaak;
  }
}
