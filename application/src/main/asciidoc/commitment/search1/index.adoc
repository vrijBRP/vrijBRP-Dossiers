...
[[commitment_find_1_success]]
===== Successful call

When making a successfull call to this API endpoint, the following request parameters and body can be expected.

[[commitment_find_1_request]]
====== Request

include::{snippets}/search_commitment1/http-request.adoc[]

[[commitment_find_1_response]]
====== Response

include::{snippets}/search_commitment1/http-response.adoc[]
