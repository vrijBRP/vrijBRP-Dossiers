...
import nl.procura.burgerzaken.dossiers.api.external.v1.client.model.RelocationConsent;

import lombok.extern.slf4j.Slf4j;
import retrofit2.Response;

@Slf4j
public class IntraRelocationConsentExample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    RelocationConsent request = IntraMunicipalRelocationData.createConsent();
    Response<Void> response = api.addIntraMunicipalRelocationConsent(request).execute();
