...
package nl.procura.burgerzaken.dossiers.api.admin.v1.relocations.emigration;
...
public class AdminApiEmigration {
  ...
  @Schema(required = true)
  private AdminApiEmigrationAddress newAddress;

  @Schema(required = true)
  private AdminApiCountry newCountry;

  @Schema(required = true)
  private List<AdminApiEmigrationPerson> relocators;
}
